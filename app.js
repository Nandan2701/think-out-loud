document.addEventListener('DOMContentLoaded', () => {
        ...
        try {
            ...
            javascriptNode.onaudioprocess = function() {
                ...
                if (volumePercent >= threshold) {
                    ...
                    // We are silent
                    const silentFor = (Date.now() - silenceStart) / 1000; // in seconds
    ...
    function playBeep() {
        const ctx = audioContext && audioContext.state !== 'closed' ? audioContext : new (window.AudioContext || window.webkitAudioContext)();
